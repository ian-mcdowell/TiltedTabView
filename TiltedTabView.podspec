...
Pod::Spec.new do |s|
  ...
  s.name         = "TiltedTabView"
  s.version      = "1.0.0"
  s.summary      = "This library aims to replicate the tab switcher in Safari on iOS. It handles both compact width (tilted) and regular width (grid) layouts."
